...
import { useUpdateUserAPI } from "@/hooks/api/user";
	...
	return (
		<div className="flex flex-col py-8 px-10 w-5/6">
			<div className="flex justify-between items-center">
				<h1 className="text-3xl font-semibold text-slate-100">Account Information</h1>
				<DateFilterComponent />
			</div>
			...
			<div className="flex items-center justify-between mt-4 mb-8">
				<div className="relative flex items-center">
					<button onClick={() => fileInputRef.current && fileInputRef.current.click()} className="relative">
						<Image
							src={AvatarDefault}
							width={50}
							height={50}
						...
						/>
						<div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white text-sm font-semibold rounded-full opacity-0 hover:opacity-100 transition duration-300 ease-in-out">
							<svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M11.4274 1.51321L10.1026 2.83799L13.6609 6.39627L14.9857 5.07149C15.67 4.38721 15.67 3.27867 14.9857 2.59438L13.9073 1.51321C13.223 0.828929 12.1144 0.828929 11.4302 1.51321H11.4274ZM9.48405 3.45658L3.10377 9.83959C2.81911 10.1243 2.61109 10.4773 2.49613 10.8633L1.52718 14.1561C1.45875 14.3887 1.52171 14.6378 1.69141 14.8075C1.86111 14.9772 2.11019 15.0402 2.34011 14.9745L5.63289 14.0055C6.01883 13.8906 6.37192 13.6825 6.65658 13.3979L13.0423 7.01486L9.48405 3.45658Z" fill="#01F7FF" />
							</svg>
							<p className="text-[#01F7FF] ml-1">Edit</p>
						</div>
					</button>
					<input
						type="file"
					...
					/>
					<div className="ml-4 items-between">
						<p className="text-slate-400 text-sm">0xABC8908345AD...ABCD08023EF</p>
					</div>
				</div>
			</div>
			{/* Connected Account */}
			...
			<div className="flex items-center justify-between mb-4 mt-4">
				<div className="flex items-center">
					...
					<svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path d="M10.8017 11.8252L18.9913 22.7524L10.75 31.6366H12.6048L19.8201 23.8583L25.6498 31.6366H31.9618L23.3114 20.0948L30.9823 11.8252H29.1275L22.4826 18.9889L17.1137 11.8252H10.8017ZM13.5293 13.1886H16.4291L29.2337 30.2731H26.334L13.5293 13.1886Z" fill="white" />
					</svg>
					<div className="ml-4">
						<p className="text-[#01F7FF] font-semibold">Connect Twitter Account</p>
					</div>
				</div>
			</div>
