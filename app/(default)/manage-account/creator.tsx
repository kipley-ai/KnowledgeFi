  ...
  return (
    <>
      ...
      <div className="flex flex-row justify-between">
        <button
          className="rounded bg-[#272B30] px-4 py-2 text-sm font-semibold text-[#01F7FF] ring-1 ring-gray-700"
          onClick={() => {
            setValues([0, 0]);
            setWithdrawValue("0");
          }}
      ...
      <button
        ...
        className="mb-2 mt-10 flex w-full flex-row items-center justify-center space-x-2 rounded-2xl bg-[#01F7FF] py-2"
      >
