						...
						<div className="flex space-x-1">
							...
							<button className="text-gray-400 hover:text-blue-500">
								...
								>
									...
									/>
									<path
										d="M15.8332 28.3334V19.1667M11.6665 20.8334V26.6667C11.6665 27.5872 12.4127 28.3334 13.3332 28.3334H24.5217C25.7556 28.3334 26.805 27.4331 26.9926 26.2135L27.8901 20.3802C28.1231 18.8658 26.9514 17.5 25.4191 17.5H22.4998C22.0396 17.5 21.6665 17.1269 21.6665 16.6667V13.7216C21.6665 12.5867 20.7465 11.6667 19.6116 11.6667C19.341 11.6667 19.0957 11.8261 18.9857 12.0735L16.0531 18.6718C15.9194 18.9727 15.6209 19.1667 15.2916 19.1667H13.3332C12.4127 19.1667 11.6665 19.9129 11.6665 20.8334Z"
										stroke="#7C878E"
										stroke-width="2"
