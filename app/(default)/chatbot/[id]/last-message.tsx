...
export const CopyButton = ({message}:{message:string}) => {
	return (
		<button className="text-gray-400 hover:text-blue-500" onClick={()=>{
...
const LastAnswer = ({
	...
	return (
		<>
			<div className="flex flex-col space-y-2 pt-5" onMouseEnter={()=>setShowCopy(true)} onMouseLeave={()=>setShowCopy(false)}>
				...
				<div className="flex flex-col space-y-2">
					...
					<div className="flex items-start space-x-3">
						<Image src={profileImage} alt="Profile" className="w-8 h-8 rounded-full mr-5" />
