        ...
        <div className="flex flex-col sm:px-6 lg:px-8 py-8 bg-[#292D32]">
            ...
            <form className="flex flex-col mt-6" onSubmit={handleSubmit}>
                ...
                <div className="form-actions mx-64 flex flex-row justify-between">
                    ...
                    <button
                        className="group flex items-center justify-center bg-[#292D32] rounded-3xl p-2 px-5 mt-8 ring-1 ring-white transition-colors duration-200 ease-in-out hover:bg-gray-800"
                        type="submit"
                    >
                        <h5 className="text-white font-semibold flex-grow group-hover:text-white transition-colors duration-200 ease-in-out">
                        ...
                        <svg
                            ...
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            className="ml-2 fill-current text-white group-hover:text-white transition-colors duration-200 ease-in-out"
                        >
                            <path d="M17.98 5.7901C18.8936 5.7901 19.6343 6.53075 19.6343 7.44439V7.44439C19.6343 8.35803 18.8936 9.09868 17.98 9.09868L1.65435 9.09868C0.74071 9.09868 5.90253e-05 8.35803 5.90618e-05 7.44439V7.44439C5.90983e-05 6.53075 0.740711 5.7901 1.65435 5.7901L17.98 5.7901Z" fill="currentColor" />
                            <path d="M18.932 5.9907C19.5219 6.63674 19.5219 7.68418 18.932 8.33022C18.3422 8.97626 17.3859 8.97626 16.7961 8.33022L12.3947 3.50927C11.8049 2.86322 11.8049 1.81578 12.3947 1.16974C12.9845 0.523702 13.9408 0.523702 14.5306 1.16974L18.932 5.9907Z" fill="currentColor" />
                        </svg>
                    </button>
