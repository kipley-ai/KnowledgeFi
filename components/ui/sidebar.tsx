          ...
          <div className="space-y-8">
            ...
            <div>
              <ul className="">
                ...
                >
                  ...
                  <SidebarLink href="/dashboard">
                    <div className="flex items-center px-3 py-1">
                      ...
                      <span className="ml-3 text-[14px] text-xs font-semibold  text-aqua-700 duration-200 lg:text-sm lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100">
                        EXPLORE
                      </span>
                    </div>
                  </SidebarLink>
                ...
                {/* Login */}
                <li
                  className={`mb-3 px-3  py-2 last:mb-0 ${
