...
export default function Header() {
  ...
  return (
    <header
      className=" z-30 border-b border-gray-700 bg-stone-800"
          ...
          <div className="flex items-center">
            ...
            <Link href="/knowledge/create">
              <button className="pr-3">
                <div className="flex items-center rounded-full border border-[#01F7FF] px-1 py-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
                    height="28"
            ...
            <Link href="/nft">
              <button className="pr-3">
                <div className="flex items-center rounded-full border border-[#01F7FF] px-2 py-1.5">
