  ...
  const typeIcon = (type: string): ReactElement => {
    switch (type) {
      case "warning":
        return (
          <svg
            className="mr-3 mt-[3px] h-4 w-4 shrink-0 fill-current text-amber-500"
            viewBox="0 0 16 16"
          >
      ...
      case "error":
        return (
          <svg
            className="mr-3 mt-[3px] h-4 w-4 shrink-0 fill-current text-rose-500"
            viewBox="0 0 16 16"
          >
      ...
      case "success":
        return (
          <svg
            className="mr-3 mt-[3px] h-4 w-4 shrink-0 fill-current text-emerald-500"
            viewBox="0 0 16 16"
          >
      ...
      default:
        return (
          <svg
            className="mr-3 mt-[3px] h-4 w-4 shrink-0 fill-current text-indigo-500"
            viewBox="0 0 16 16"
          >
